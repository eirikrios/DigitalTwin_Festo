...
HistoricoEquipamento = [
    ...
    (10.5, 9.8, 22.0, 38.0, 6.5, 55.0, 400, "FALHA"),  
    (7.0, 11.5, 25.0, 50.0, 2.2, 45.0, 250, "FALHA"), 
    (6.0, 6.1, 90.0, 30.0, 4.0, 70.0, 200, "FALHA"),   
    (8.0, 7.9, 15.0, 95.0, 3.1, 60.0, 100, "FALHA"),   
    (5.5, 5.2, 25.0, 50.0, 11.0, 65.0, 150, "FALHA"), 
    (6.5, 6.0, 30.0, 40.0, 8.5, 50.0, 180, "ALERTA"), 
    (4.8, 5.0, -30.0, 20.0, 3.2, 40.0, 200, "FALHA"),  
    (7.2, 6.9, 25.0, 60.0, 2.0, 55.0, 40, "FALHA"),  
    (3.5, 3.2, 28.0, 30.0, 1.5, 42.0, 450, "OK"),
    (6.9, 7.0, 32.0, 80.0, 3.3, 65.0, 300, "OK"),
    (9.0, 8.8, 18.0, 85.0, 4.2, 48.0, 280, "ALERTA"),
    ...
    (10.2, 9.9, 10.0, 55.0, 2.7, 58.0, 100, "FALHA"),
    (4.2, 4.0, 27.0, 20.0, 7.5, 52.0, 300, "ALERTA")
]
